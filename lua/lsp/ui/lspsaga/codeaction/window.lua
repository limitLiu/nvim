...
local api = require "lsp.ui.lspsaga.api"
...
M.open = function(opts)
  ...
  cmd 'autocmd CursorMoved <buffer> lua require("lsp.ui.lspsaga.codeaction.window").set_cursor()'
  cmd "autocmd QuitPre <buffer> lua require('lsp.ui.lspsaga.codeaction.window').close()"
...
M.execute_one = function()
  M.execute(1)
end
M.execute_two = function()
  M.execute(2)
end
M.execute_three = function()
  M.execute(3)
end
M.execute_four = function()
  M.execute(4)
end
M.execute_five = function()
  M.execute(5)
end
M.execute_six = function()
  M.execute(6)
end
M.execute_seven = function()
  M.execute(7)
end
M.execute_eight = function()
  M.execute(8)
end
M.execute_nine = function()
  M.execute(9)
end
