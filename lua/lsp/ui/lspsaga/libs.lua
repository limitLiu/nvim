...
local server_filetype_map =
  require("lsp.ui.lspsaga").config_values.server_filetype_map
...
function libs.apply_keys(ns, actions)
  local map = function(func, keys)
    ...
    local fmt =
      "nnoremap <buffer><nowait><silent>%s <cmd>lua require('lsp.ui.lspsaga.%s').%s()<CR>"
